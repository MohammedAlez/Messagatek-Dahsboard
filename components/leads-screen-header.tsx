    ...
    <div className="flex flex-wrap items-center justify-between gap-4 py-4">
      ...
      <div className="relative flex w-full max-w-sm ">
        <Input 
          ...
          className="p-5 flex-1 block pr-11 bg-background focus-visible:ring-1 focus-visible:ring-purple-600"
        />
        <button className=" absolute right-1.5 top-1.25 size-5 h-8 cursor-pointer w-8 flex items-center justify-center bg-purple-500 hover:bg-purple-600 rounded-lg">
      ...
      <div className="flex w-full lg:w-fit items-center justify-between gap-3">
        ...
        {/* Export Button */}
        <Button variant="outline" className="gap-2 bg-purple-500 text-slate-100 hover:bg-purple-600 hover:text-slate-100 p-5 rounded-xl cursor-pointer">
